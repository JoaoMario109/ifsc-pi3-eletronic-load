...
/** LVGL Semaphore and Task handlers */
SemaphoreHandle_t h_lvgl_mux;
...
static void lcd_lvgl_init(void);
...
bool lvgl_mutex_lock(int timeout_ms)
{
    ...
    return xSemaphoreTakeRecursive(h_lvgl_mux, timeout_ticks) == pdTRUE;
}
...
{
    xSemaphoreGiveRecursive(h_lvgl_mux);
}
...
void lcd_lvgl_init(void)
{
    ...
    h_lvgl_mux = xSemaphoreCreateRecursiveMutex();
    assert(h_lvgl_mux);
}
